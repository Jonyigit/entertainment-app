...
import saveStyle from "./save.module.scss";
import { useNavigate } from "react-router-dom";
import { useMutation } from "@tanstack/react-query";
import AddBookMark from "../../../service/AddBookMark/addBookMark";
import removeBookMaker from "../../../service/AddBookMark/removeBookMark";

function Save({ isBookmarked, movieId }: { isBookmarked: boolean | undefined; movieId: string | undefined }) {
    const [isActive, setIsActive] = useState<boolean | undefined>(isBookmarked);
